...
short ReadHowManyRounds()
{
    ...
    do
    {
        cout << "How Many Rounds Do You Want To Play? (From 1 : 10) \n";
        cin >> GameRounds;
...
void SetScreenColorAndSound(enWinner Winner)
{
...
void PrintRoundResults(stRoundInfo RoundInfo)
{
    ...
    SetScreenColorAndSound(RoundInfo.Winner);
}
...
stGameResults PlayGame(short HowManyRounds)
{
    ...
    return { HowManyRounds, Player1WinTimes, ComputerWinTimes, DrawTimes, GameWinner, WinnerName(GameWinner) };
}
...
void PrintGameOverScreen(stGameResults GameResults)
{
    ...
    SetScreenColorAndSound(GameResults.GameWinner);
}
